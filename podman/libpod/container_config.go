...
type ContainerMiscConfig struct {
	...
	ExternalSetup             bool   `json:"externalSetup,omitempty"`
	ExternalBundlePath        string `json:"externalBundlePath,omitempty"`
	TforkImgDir               string `json:"tforkImgDir,omitempty"`
