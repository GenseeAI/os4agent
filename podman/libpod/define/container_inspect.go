...
type InspectContainerData struct {
	...
	Tfork *InspectContainerTfork `json:"Tfork,omitempty"`
}

type InspectContainerTfork struct {
	SourceID       string `json:"SourceID,omitempty"`
	ImageDir       string `json:"ImageDir,omitempty"`
	Persistent     string `json:"Persistent,omitempty"`
	DumpStatus     string `json:"DumpStatus,omitempty"`
	ParentCloneID  string `json:"ParentCloneID,omitempty"`
	DumpdHolderPid int    `json:"DumpdHolderPid,omitempty"`
}
