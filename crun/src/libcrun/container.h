...
struct libcrun_checkpoint_restore_s
{
  ...
  const char *tfork_snap_root;

  char **tfork_snap_roots;
  size_t tfork_snap_roots_n;

  char **tfork_snap_mounts;
  size_t tfork_snap_mounts_n;
  bool tfork_memdump;
  bool tfork_memdump_async;
  bool track_mem;
  int tfork_copies;
  ...
  char **external;
  size_t external_n;
  char **tfork_copy_args;
  size_t tfork_copy_args_n;
  char **cgroup_root;
  size_t cgroup_root_n;
};
...
LIBCRUN_PUBLIC int libcrun_container_tfork (libcrun_context_t *context, libcrun_container_t *container,
                                            libcrun_checkpoint_restore_t *cr_options, libcrun_error_t *err);
