...
int
libcrun_container_tfork_linux (libcrun_container_t *container, libcrun_checkpoint_restore_t *cr_options,
                               pid_t *clone_pid_out, libcrun_error_t *err)
{
  return libcrun_container_tfork_linux_criu (container, cr_options, clone_pid_out, err);
}
