...
int libcrun_container_tfork_linux_criu (libcrun_container_t *container,
...
static inline int
libcrun_container_tfork_linux_criu (arg_unused libcrun_container_t *container,
                                    arg_unused libcrun_checkpoint_restore_t *cr_options,
                                    arg_unused pid_t *clone_pid_out, libcrun_error_t *err)
{
  return crun_make_error (err, 0, "compiled without CRIU support. tfork not available");
}
