...
struct filecow_layer {
	struct xarray		pages;
	refcount_t		refs;
	struct filecow_layer	*below;
	u64			generation;
	struct inode		*primary_inode;
	spinlock_t		sharers_lock;
	struct list_head	sharers;
...
static inline struct folio *filecow_lookup(struct address_space *mapping,
					   pgoff_t index, gfp_t gfp)
{
	return NULL;
}
static inline void *xa_make_tombstone(void) { return NULL; }
static inline bool xa_is_tombstone(void *entry) { return false; }
