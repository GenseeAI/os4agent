...
struct address_space_operations {
	...
	bool (*folio_extent_shared)(struct folio *folio,
				    struct address_space *src_mapping,
				    struct address_space *snap_mapping);
	void (*folio_extents_shared_bulk)(struct address_space *src,
...
struct address_space {
	...
	void *			i_private_data;
#ifdef CONFIG_FILECOW
	struct filecow_layer	*ro;
	struct list_head	filecow_link;
#endif
} __attribute__((aligned(sizeof(long)))) __randomize_layout;

static inline struct filecow_layer *
mapping_filecow_layer(const struct address_space *mapping)
{
#ifdef CONFIG_FILECOW
	return mapping->ro;
#else
