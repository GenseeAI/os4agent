...
extern int prepare_itimers(int uid, struct task_restore_args *args, CoreEntry *core);
extern int prepare_posix_timers(int uid, struct task_restore_args *ta, CoreEntry *core);
