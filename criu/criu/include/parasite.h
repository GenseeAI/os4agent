...
#define HELPER_IOV_AIO_FLAG	(1ULL << 63)

struct parasite_fork_dump_pages_args {
	int		child_pid;
	int		image_fd;
	int		iovs_fd;
	unsigned int	nr_iovs;
	unsigned long	iovs_bytes;
	unsigned long	aio_bytes;
	unsigned long	iovs_map_base;
	unsigned long	helper_stack_top;
};
