...
struct thread_restore_args {
	...
	int pid;
	int tid_in_ns[MAX_PID_NS_LEVEL];
	int ns_level;
...
struct task_restore_args {
	...
	bool tfork_mode;
	int vma_cherrypick_fd;
	int target_pidfd;
	int target_memfd;
	int target_pagemap_fd;
	int tfork_pidfd_base;
	int tfork_snap_root_fd;

	futex_t *tfork_fdt_done;
	int tfork_fdt_nr;
	int tfork_ncopy_ready_fd;
