...
int check_img_inventory(bool restore)
{
	...
	if (he->has_host_user_ns_id)
		host_user_ns_id = he->host_user_ns_id;
...
int prepare_inventory(InventoryEntry *he)
{
	...
	he->host_user_ns_id = find_host_user_ns_id();
	he->has_host_user_ns_id = (he->host_user_ns_id != 0);
