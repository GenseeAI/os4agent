#ifndef _PKEY_STATE_H
#define _PKEY_STATE_H
...
#error "Compile failed: " KBUILD_MODNAME " is strictly bound to the x86_64 architecture."
#endif

#ifndef CONFIG_X86_INTEL_MEMORY_PROTECTION_KEYS
#error "Compile failed: " KBUILD_MODNAME " requires CONFIG_X86_INTEL_MEMORY_PROTECTION_KEYS to expose mm->context.pkey_allocation_map."
#endif
