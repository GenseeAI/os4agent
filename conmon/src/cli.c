...
GOptionEntry opt_entries[] = {
	...
	{"tfork", 0, 0, G_OPTION_ARG_NONE, &opt_tfork,
	 "Run `<runtime> tfork` instead of create/restore (CRIU live-clone path; --restore supplies the criu image dir)", NULL},
